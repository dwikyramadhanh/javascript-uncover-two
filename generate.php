<?php
  ...
  //buat database duniailkom_ajax jika belum ada
  $query = "CREATE DATABASE IF NOT EXISTS duniailkom_ajax";
  ...
  if(!$result){
    ...
    echo "Database <b>'duniailkom_ajax'</b> berhasil dibuat... <br>";
  }
  
  //pilih database duniailkom_ajax
  $result = mysqli_select_db($link, "duniailkom_ajax");
  ...
  if(!$result){
    ...
    echo "Database <b>'duniailkom_ajax'</b> berhasil dipilih... <br>";
  }
